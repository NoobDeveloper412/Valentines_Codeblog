...
import filtered from "../util/blogFilter";
                                ...
                                <div className="row align-items-end mt-50">
                                    <div className="col-lg-7 mb-20">
                                        <div className="d-inline-block position-relative">
                                            <h1 className="color-white mb-20 color-linear wow animate__animated animate__fadeIn">Python</h1><span className="btn btn-linear-small btn-number-arts">{posts.length} Articles</span>
                                        </div>
                                    ...
                                    <div className="col-lg-5 mb-20 text-start text-lg-end">
                                        <div className="box-breadcrumbs wow animate__animated animate__fadeIn">
                                            <ul className="breadcrumb">
                                                ...
                                                <li><Link href="/blog-archive">{posts.category}</Link></li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div className="col-lg-4">
                                                <div className="card-blog-1 border-gray-800 bg-gray-850 hover-up">
                                                    <div className="card-image mb-20">
                                                        ...
                                                        <Link href={`/python/${item.slug}`}>
                                                            <img src={`assets/imgs/page/${item.category}/${item.slug}.png`} alt="Genz" />
                                                        </Link>
                                                    </div>
                                                    <div className="card-info">
                                                        <div className="row">
                                                            <div className="col-7"><h6 className="color-gray-700 text-sm">Difficulty: {item.difficulty}</h6></div>
                                                            <div className="col-5 text-end"><span className="color-gray-700 text-sm timeread">3 mins read</span></div>
                                                        </div><Link href={`/python/${item.slug}`}>
                                                            <h5 className="color-linear mt-10">{item.title}</h5></Link>
                                                        <div className="row align-items-center mt-20">
                                                            <div className="col-10">
                                                                <div className="box-author"><img src="assets/imgs/page/about/author.png" alt="Genz" />
                                                                    <div className="author-info">
                                                                        <h6 className="color-linear-2">Valentin Cavarec</h6><span className="color-gray-700 text-sm">{item.date}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
